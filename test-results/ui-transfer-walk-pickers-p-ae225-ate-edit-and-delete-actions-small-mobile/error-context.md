...
- generic [ref=e2]:
  - main [ref=e4]:
    - region "Сервис совместных прогулок" [ref=e5]:
      - generic [ref=e6]:
        ...
        - heading "Сообщить о прогулке" [level=1] [ref=e17]
        - paragraph [ref=e18]: Расскажите соседям, где вас найти.
        - generic [ref=e19]:
          - button "Питомец" [active] [ref=e20] [cursor=pointer]:
            - img "Луна" [ref=e21]
            - generic [ref=e22]:
  ...
  - generic:
    - dialog "С кем гуляем" [ref=e64]:
      - button "Луна Луна Корги · Анна Ваш питомец" [ref=e69] [cursor=pointer]:
        - img "Луна" [ref=e70]
        - generic [ref=e71]:
          - strong [ref=e72]: Луна
          - generic [ref=e73]: Корги · Анна
          - emphasis [ref=e74]: Ваш питомец
      - button "Добавить питомца" [ref=e76] [cursor=pointer]
    - button "Закрыть" [ref=e77] [cursor=pointer]
```
