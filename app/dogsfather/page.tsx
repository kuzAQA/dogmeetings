...
export default function AdminPage() {
  ...
  return <DogmeetFrame><main><section className="admin-shell">
    ...
    {result?.sheet && <DogmeetDialog title={result.heading} onDismiss={() => setResult(null)} footer={<button className="button" type="button" onClick={(event) => requestDialogClose(event.currentTarget, () => setResult(null))}>Готово<ArrowRight aria-hidden="true" /></button>}><DogmeetState state="success" title={result.title} message={result.message} /></DogmeetDialog>}
